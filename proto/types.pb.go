...
const file_proto_types_proto_rawDesc = "" +
	...
	"\ftransactions\x18\x02 \x03(\v2\f.TransactionR\ftransactions\"\xb4\x01\n" +
	"\x06Header\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12\x16\n" +
	"\x06height\x18\x02 \x01(\x05R\x06height\x12#\n" +
	"\rprevious_hash\x18\x03 \x01(\fR\fpreviousHash\x12\x1f\n" +
	"\vmerkle_root\x18\x04 \x01(\fR\n" +
	"merkleRoot\x12\x1c\n" +
	"\ttimestamp\x18\x05 \x01(\x03R\ttimestamp\x12\x14\n" +
	"\x05nonce\x18\x06 \x01(\fR\x05nonce\"\x89\x01\n" +
	"\aTxInput\x12\x1e\n" +
	"\n" +
	...
	"\aoutputs\x18\x03 \x03(\v2\t.TxOutputR\aoutputsB#Z!github.com/fayob/blockchain/protob\x06proto3"
